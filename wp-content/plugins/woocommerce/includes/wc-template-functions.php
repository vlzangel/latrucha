	...
	function woocommerce_template_loop_product_title() {
		/*echo '
			<h2	class="woocommerce-loop-product__title"> 
				<a href="'.get_the_permalink().'?add-to-cart='.get_the_ID().'&wc_bookings_field_duration=1&wc_bookings_field_persons=1&wc_bookings_field_start_date_day=6&wc_bookings_field_start_date_month=4&wc_bookings_field_start_date_year=2018&wc_bookings_field_start_date_to_day=7&wc_bookings_field_start_date_to_month=4&wc_bookings_field_start_date_to_year=2018"> 
					'. get_the_title().'
				</a>
			</h2>';*/
