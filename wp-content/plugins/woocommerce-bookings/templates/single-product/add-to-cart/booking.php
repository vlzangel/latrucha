...
<form id="form_servicio" class="cart" method="post" enctype='multipart/form-data'>
	...
	<button type="submit" class="wc-bookings-booking-form-button single_add_to_cart_button button alt xdisabled" style="display:none"><?php echo $product->single_add_to_cart_text(); ?></button>
